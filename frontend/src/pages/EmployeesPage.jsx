          ...
          return (
            <div key={emp.id} className="card p-0 overflow-hidden">
              <div className="flex items-start gap-4 p-4">
                <img
                  src={`https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(emp.name)}&backgroundColor=e95420&fontFamily=Ubuntu&fontSize=38`}
              ...
              {isExp && emp.projectMembers?.length > 0 && (
                <div className="px-4 pb-4" style={{ borderTop: '1px solid #2E2E2E' }}>
